...
def glossary_page():
    ...
    styles = {
        ...
        "stats": {"c": "#3B82F6", "bg": "rgba(139,92,246,0.1)"},
        "design": {"c": "#3B82F6", "bg": "rgba(236,72,153,0.1)"},
        "ux": {"c": "#8A8F99", "bg": "rgba(6,182,212,0.1)"},
        "multimedia": {"c": "#F59E0B", "bg": "rgba(249,115,22,0.1)"}
    }
